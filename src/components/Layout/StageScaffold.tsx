...
export const StageScaffold: React.FC<StageScaffoldProps> = ({ 
  ...
  return (
    <div className="flex flex-col h-full bg-gray-950 text-gray-200">
      ...
      <div className="h-[88px] border-b border-gray-800 flex justify-between items-center px-4 md:px-6 bg-gray-900/50 backdrop-blur-sm sticky top-0 z-40 shrink-0">
        <div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-1 max-w-[200px] md:max-w-none truncate">{description}</p>
        </div>
